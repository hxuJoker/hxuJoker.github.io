export default [
  {
    name: 'Node 基础和实践',
    router: '/node',
    description:'文章中主要讲述 Node 的基础用法和一些常用的 Api，适用于初学 Node 的阅读，同样做到温故知新。属自己一些小总结，如有不妥请告知，不喜勿喷，谢谢~',
    image: 'http://static.nodejs.cn/_static/img/logo.svg',
    style: 'background:#333'
  },
  {
    name: 'TypeScript 基础入门',
    router: '/ts',
    description:'文章中主要讲述 TypeScript 的基础用法，定义数据类型规范，ts 中的方法、类、继承、接口等内容。属自己一些小总结，如有不妥请告知，不喜勿喷，谢谢~',
    image: 'https://www.runoob.com/wp-content/uploads/2019/01/typescript-logo.jpg',
  },
  {
    name: 'ES5 和 ES6 中类的区别',
    router: '/es',
